import { CLEAR_DETAIL, ERROR, FILTER_BY_CREATION, FILTER_BY_GENRE, GET_ALL_GAMES, GET_ALL_GENRES, GET_GAME_BY_NAME, GET_GAME_DETAIL, ORDER_BY_NAME, ORDER_BY_RATING, POST_NEW_GAME } from "../actions/actionTypes";
